...
--
-- Host: 127.0.0.1:53381
-- Generation Time: Nov 27, 2022 at 07:52 PM
...
--
-- Table structure for table `e dependent`
--
...
--
-- Table structure for table `patientassigneddoctor`
--
...
--
-- Dumping data for table `patientassigneddoctor`
--
...
--
-- Indexes for table `patientassigneddoctor`
--
...
ALTER TABLE `appointment`
  ...
  ADD CONSTRAINT `dop` FOREIGN KEY (`CLINIC_ID`) REFERENCES `clinics` (`Clinic_Id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `was` FOREIGN KEY (`Doctor`) REFERENCES `doctors` (`DoctorID`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Constraints for table `e dependent`
--
ALTER TABLE `e dependent`
...
--
-- Constraints for table `patientassigneddoctor`
--
ALTER TABLE `patientassigneddoctor`
